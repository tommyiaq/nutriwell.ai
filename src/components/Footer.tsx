    ...
    <footer className="nv-footer">
      <div className="nv-container nv-footer-container">
        <div className="nv-footer-content">
          ...
          <div className="nv-footer-column nv-footer-brand">
            ...
            <div className="nv-social-icons">
              <span className="nv-social-title">{t('footer.social.title')}</span>
              <div className="nv-social-links">
                <a href="https://linkedin.com/company/nutriwell-ai" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                  <i className="fab fa-linkedin"></i>
                </a>
                <a href="https://facebook.com/nutriwell.ai" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                  <i className="fab fa-facebook"></i>
                </a>
                <a href="https://instagram.com/nutriwell.ai" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  <i className="fab fa-instagram"></i>
                </a>
                <a href="https://youtube.com/@nutriwell-ai" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
          ...
          <div className="nv-footer-column">
            ...
            <ul className="nv-footer-links">
              ...
              <li><Link href="/#features">{t('footer.links.features')}</Link></li>
              <li><Link href="/#pricing">{t('footer.links.pricing')}</Link></li>
              <li><Link href="/chat">{t('footer.links.chat')}</Link></li>
            </ul>
          </div>
        ...
        <div className="nv-footer-bottom">
          ...
          <div className="nv-footer-copyright">
            {t('footer.copyright')}
          </div>
        </div>
      </div>
